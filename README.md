...
- [� Shopease-API](#-shopease-api)
  - [🧭 Auth Flow Diagram](#-auth-flow-diagram)
  - [📑 Table of Contents](#-table-of-contents)
  - [🚀 Features](#-features)
    - [✅ Authentication \& Authorization](#-authentication--authorization)
    - [🛒 E-Commerce Core (Planned \& In Progress)](#-e-commerce-core-planned--in-progress)
    - [🛠 Admin Features (Planned)](#-admin-features-planned)
...
```bash
git clone https://github.com/kihuni/shopease-api.git
cd shopease-api
